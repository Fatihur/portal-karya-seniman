...
<body>
        ...
        <div class="container-fluid px-3">
            ...
            <div class="d-flex align-items-center">
                ...
                <a class="navbar-brand d-flex align-items-center p-0" href="{{ route('admin.dashboard') }}">
                    ...
                    <span class="fw-bold d-none d-sm-block font-display">Admin Panel</span>
                    <span class="fw-bold d-sm-none font-display" style="font-size: 15px;">Admin</span>
                </a>
            </div>
    ...
    <div class="offcanvas offcanvas-start offcanvas-sidebar" tabindex="-1" id="mobileSidebar" aria-labelledby="mobileSidebarLabel">
        <div class="offcanvas-header">
            <h5 class="offcanvas-title font-display" id="mobileSidebarLabel">Menu Admin</h5>
        ...
        <div class="row g-0">
            ...
            <main class="col-md-9 col-lg-10 admin-content p-3 p-md-4">
                ...
                <div class="page-title-bar d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center mb-4 gap-2">
                    <h1 class="h4 mb-0 font-display">@yield('title', 'Dashboard')</h1>
